...
X <- mtcars %>% select(-mpg) %>% scale() %>% as.matrix()
...
# Now we code our own heteroskedastic ridge regression, since this is not implemented
# in glmnet
...
# Now we train an Elastic Net using the caret package
